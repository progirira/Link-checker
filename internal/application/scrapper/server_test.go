...
//	dict := &repository.DictionaryStorage{Chats: make(map[int64]*scrappertypes.Chat)}
//	s := &scrapper.Server{
//		Storage: dict,
//	}
//
...
//	dict := &dictionary_storage.DictionaryStorage{Chats: make(map[int64]*scrappertypes.Chat)}
//	s := &scrapper.Server{
//		Storage: dict,
//	}
//
